@STATIC;1.0;p;13;CPArray+KVO.jt;18379;@STATIC;1.0;i;9;CPArray.ji;8;CPNull.jt;18334;objj_executeFile("CPArray.j", YES);
...
{
    if (_insert)
        return _insert(_proxyObject, _insertSEL, anObject, objj_msgSend(CPIndexSet, "indexSetWithIndex:", objj_msgSend(self, "count")));
    else if (_insertMany)
        return _insertMany(_proxyObject, _insertManySEL, [anObject], objj_msgSend(CPIndexSet, "indexSetWithIndex:", objj_msgSend(self, "count")));
...
{
    if (_insertMany)
        return _insertMany(_proxyObject, _insertManySEL, anArray, objj_msgSend(CPIndexSet, "indexSetWithIndexesInRange:", CPMakeRange(objj_msgSend(self, "count"), objj_msgSend(anArray, "count"))));
    var index = 0,
...
{ with(self)
{
    if (_insert)
        ...
        return _insertMany(_proxyObject, _insertManySEL, [anObject], objj_msgSend(CPIndexSet, "indexSetWithIndex:", anIndex));
    var target = objj_msgSend(objj_msgSend(self, "_representedObject"), "copy");
...
{ with(self)
{
    if (objj_msgSend(isa, "instanceMethodForSelector:", _cmd) === objj_msgSend(CPArray, "instanceMethodForSelector:", _cmd))
        objj_msgSend(CPException, "raise:reason:", CPInvalidArgumentException, "[CPArray addObserver:forKeyPath:options:context:] is not supported. Key path: " + aKeyPath);
    else
...
{
    if (objj_msgSend(isa, "instanceMethodForSelector:", _cmd) === objj_msgSend(CPArray, "instanceMethodForSelector:", _cmd))
        objj_msgSend(CPException, "raise:reason:", CPInvalidArgumentException, "[CPArray removeObserver:forKeyPath:] is not supported. Key path: " + aKeyPath);
    else
...
p;9;CPArray.jt;30937;@STATIC;1.0;i;14;CPEnumerator.ji;13;CPException.ji;10;CPObject.ji;9;CPRange.ji;18;CPSortDescriptor.jt;30829;objj_executeFile("CPEnumerator.j", YES);
...
},["id"]), new objj_method(sel_getUid("countByEnumeratingWithState:objects:count:"), function $_CPArrayEnumerator__countByEnumeratingWithState_objects_count_(self, _cmd, aState, objects, aCount)
{ with(self)
{
...
var the_class = objj_getClass("CPArray")
if(!the_class) throw new SyntaxError("*** Could not find definition for class \"CPArray\"");
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("countByEnumeratingWithState:objects:count:"), function $CPArray__countByEnumeratingWithState_objects_count_(self, _cmd, aState, objects, aCount)
{ with(self)
{
    var count = objj_msgSend(self, "count"),
        index = aState.state;
...
p;14;CPDictionary.jt;12678;@STATIC;1.0;i;9;CPArray.ji;14;CPEnumerator.ji;13;CPException.ji;10;CPObject.jt;12593;objj_executeFile("CPArray.j", YES);
...
var the_class = objj_getClass("CPDictionary")
if(!the_class) throw new SyntaxError("*** Could not find definition for class \"CPDictionary\"");
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("countByEnumeratingWithState:objects:count:"), function $CPDictionary__countByEnumeratingWithState_objects_count_(self, _cmd, aState, objects, aCount)
{ with(self)
{
    var count = objj_msgSend(self, "count");
...
p;14;CPEnumerator.jt;855;@STATIC;1.0;i;10;CPObject.jt;822;objj_executeFile("CPObject.j", YES);
...
},["CPArray"]), new objj_method(sel_getUid("countByEnumeratingWithState:objects:count:"), function $CPEnumerator__countByEnumeratingWithState_objects_count_(self, _cmd, aState, objects, aCount)
{ with(self)
{
...
p;12;CPIndexSet.jt;21607;@STATIC;1.0;i;10;CPObject.ji;9;CPRange.jt;21559;objj_executeFile("CPObject.j", YES);
objj_executeFile("CPRange.j", YES);
...
var the_class = objj_getClass("CPIndexSet")
if(!the_class) throw new SyntaxError("*** Could not find definition for class \"CPIndexSet\"");
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("countByEnumeratingWithState:objects:count:"), function $CPIndexSet__countByEnumeratingWithState_objects_count_(self, _cmd, aState, objects, aCount)
{ with(self)
{
...
p;18;CPKeyValueCoding.jt;9604;@STATIC;1.0;i;9;CPArray.ji;14;CPDictionary.ji;8;CPNull.ji;10;CPObject.ji;21;CPKeyValueObserving.ji;13;CPArray+KVO.jt;9482;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPDictionary.j", YES);
objj_executeFile("CPNull.j", YES);
objj_executeFile("CPObject.j", YES);
...
p;21;CPKeyValueObserving.jt;28132;@STATIC;1.0;i;9;CPArray.ji;14;CPDictionary.ji;13;CPException.ji;8;CPNull.ji;10;CPObject.ji;7;CPSet.ji;13;CPArray+KVO.jt;28006;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPDictionary.j", YES);
objj_executeFile("CPException.j", YES);
objj_executeFile("CPNull.j", YES);
objj_executeFile("CPObject.j", YES);
...
p;8;CPNull.jt;1795;@STATIC;1.0;i;10;CPObject.jt;1761;objj_executeFile("CPObject.j", YES);
...
var the_class = objj_getClass("CPNull")
if(!the_class) throw new SyntaxError("*** Could not find definition for class \"CPNull\"");
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("initWithCoder:"), function $CPNull__initWithCoder_(self, _cmd, aCoder)
{ with(self)
{
    return objj_msgSend(CPNull, "null");
}
...
var the_class = objj_getClass("CPNull")
if(!the_class) throw new SyntaxError("*** Could not find definition for class \"CPNull\"");
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("countByEnumeratingWithState:objects:count:"), function $CPNull__countByEnumeratingWithState_objects_count_(self, _cmd, aState, objects, aCount)
{ with(self)
{
    return 0;
}
...
p;7;CPSet.jt;12361;@STATIC;1.0;i;9;CPArray.ji;14;CPEnumerator.ji;10;CPNumber.ji;10;CPObject.jt;12279;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPEnumerator.j", YES);
objj_executeFile("CPNumber.j", YES);
objj_executeFile("CPObject.j", YES);
...
var the_class = objj_getClass("CPSet")
if(!the_class) throw new SyntaxError("*** Could not find definition for class \"CPSet\"");
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("countByEnumeratingWithState:objects:count:"), function $CPSet__countByEnumeratingWithState_objects_count_(self, _cmd, aState, objects, aCount)
{ with(self)
{
    var count = objj_msgSend(self, "count");
    if (aState.state >= count)
...
p;10;CPString.jt;17011;@STATIC;1.0;i;13;CPException.ji;10;CPObject.ji;18;CPSortDescriptor.ji;9;CPValue.jt;16922;objj_executeFile("CPException.j", YES);
objj_executeFile("CPObject.j", YES);
objj_executeFile("CPSortDescriptor.j", YES);
objj_executeFile("CPValue.j", YES);
...
p;20;CPValueTransformer.jt;6618;@STATIC;1.0;I;21;Foundation/CPObject.jI;25;Foundation/CPDictionary.jt;6543;objj_executeFile("Foundation/CPObject.j", NO);
...
class_addMethods(meta_class, [new objj_method(sel_getUid("setValueTransformer:forName:"), function $CPValueTransformer__setValueTransformer_forName_(self, _cmd, aTransformer, aName)
{ with(self)
{
    objj_msgSend(transformerMap, "setObject:forKey:", aTransformer, aName);
}
...
{var the_class = objj_allocateClassPair(CPObject, "CPNegateBooleanTransformer"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
{var the_class = objj_allocateClassPair(CPObject, "CPIsNilTransformer"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
{var the_class = objj_allocateClassPair(CPObject, "CPIsNotNilTransformer"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
{var the_class = objj_allocateClassPair(CPObject, "CPUnarchiveFromDataTransformer"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
p;23;CPComparisonPredicate.jt;18688;@STATIC;1.0;i;9;CPArray.ji;8;CPNull.ji;10;CPString.ji;14;CPEnumerator.ji;13;CPPredicate.ji;14;CPExpression.ji;23;CPExpression_operator.jt;18544;
...
{ with(self)
{
    ...
    var right = objj_msgSend(_right, "_expressionWithSubstitutionVariables:", variables);
...
{ with(self)
{
    ...
    var rightIsNil = (rhs == nil || objj_msgSend(rhs, "isEqual:", objj_msgSend(CPNull, "null")));
    ...
    switch (_type)
    {
        ...
        case CPBetweenPredicateOperatorType:
            ...
            var upper = objj_msgSend(rhs, "objectAtIndex:", 1);
...
{ with(self)
{
    ...
    var rightValue = objj_msgSend(right, "expressionValueWithObject:context:", object, nil);
...
p;21;CPCompoundPredicate.jt;7107;@STATIC;1.0;i;13;CPPredicate.jI;20;Foundation/CPArray.jI;21;Foundation/CPString.jt;7019;
...
{ with(self)
{
    ...
    for (i = 0; i < count; i++)
    {
        ...
        var sp = objj_msgSend(p, "predicateWithSubstitutionVariables:", variables);
...
{ with(self)
{
    ...
    for (i = 0; i < count; i++)
    {
        ...
        var precedence = objj_msgSend(subpredicate, "predicateFormat");
...
},["CPExpression","CPExpression","CPExpression"]), new objj_method(sel_getUid("expressionForIntersectSetSet:with:"), function $CPExpression__expressionForIntersectSetSet_with_(self, _cmd, left, right)
{ with(self)
{
...
p;23;CPExpression_constant.jt;2684;@STATIC;1.0;i;14;CPExpression.jI;25;Foundation/CPDictionary.jt;2616;
...
p;23;CPExpression_function.jt;15842;@STATIC;1.0;i;14;CPExpression.jI;21;Foundation/CPString.jI;20;Foundation/CPArray.jI;25;Foundation/CPDictionary.jt;15722;
...
{ with(self)
{
    var name = objj_msgSend(coder, "decodeObjectForKey:", "CPExpressionFunctionName");
...
{ with(self)
{
    ...
    var num = objj_msgSend(objj_msgSend(parameters, "objectAtIndex:", 0), "doubleValue");
    var power = objj_msgSend(objj_msgSend(parameters, "objectAtIndex:", 1), "doubleValue");
...
{ with(self)
{
    ...
    var left = objj_msgSend(parameters, "objectAtIndex:", 0);
    var right = objj_msgSend(parameters, "objectAtIndex:", 1);
...
p;27;CPExpression_intersectset.jt;4151;@STATIC;1.0;i;14;CPExpression.jt;4113;
...
{ with(self)
{
    ...
    while (item = objj_msgSend(e, "nextObject"))
        if (objj_msgSend(left, "containsObject:", item))objj_msgSend(set, "addObject:", item);
...
},["CPExpression"]), new objj_method(sel_getUid("leftExpression"), function $CPExpression_intersectset__leftExpression(self, _cmd)
{ with(self)
{
    return _right;
}
...
p;22;CPExpression_keypath.jt;2603;@STATIC;1.0;i;14;CPExpression.jI;21;Foundation/CPString.jI;29;Foundation/CPKeyValueCoding.jt;2505;
...
},["CPExpression"]), new objj_method(sel_getUid("leftExpression"), function $CPExpression_minusset__leftExpression(self, _cmd)
{ with(self)
{
    return _right;
}
...
{ with(self)
{
    ...
    for (i = 0; i < count; i++)
    {
        ...
        var precedence = objj_msgSend(check, "description");
...
p;19;CPExpression_self.jt;1874;@STATIC;1.0;i;14;CPExpression.jI;21;Foundation/CPString.jI;25;Foundation/CPDictionary.jI;20;Foundation/CPCoder.jt;1755;
...
p;23;CPExpression_unionset.jt;3990;@STATIC;1.0;i;14;CPExpression.jt;3952;


objj_executeFile("CPExpression.j", YES);

{var the_class = objj_allocateClassPair(Nil, "CPExpression_unionset"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
},["CPExpression"]), new objj_method(sel_getUid("leftExpression"), function $CPExpression_unionset__leftExpression(self, _cmd)
{ with(self)
{
    return _right;
}
...
p;23;CPExpression_variable.jt;2881;@STATIC;1.0;i;14;CPExpression.jI;21;Foundation/CPString.jI;25;Foundation/CPDictionary.jt;2787;
...
{ with(self)
{
    ...
    while (count--)
    {
        var check = objj_msgSend(self, "objectAtIndex:", count);
        if (!objj_msgSend(predicate, "evaluateWithObject:", check))
...
{ with(self)
{
    ...
    else if (objj_msgSend(self, "scanPredicateKeyword:", "BETWEEN"))
    {
        ...
        return objj_msgSend(CPCompoundPredicate, "andPredicateWithSubpredicates:", 
                objj_msgSend(CPArray, "arrayWithObjects:", lp, up, nil));
    }
    else
...
{ with(self)
{
    ...
    if (!_identifier)
    {
        _identifier = objj_msgSend(CPCharacterSet, "characterSetWithCharactersInString:", "_$abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789");
    }
    if (!objj_msgSend(self, "scanCharactersFromSet:intoString:", _identifier, function(newValue){ var oldValue = ident; if (typeof newValue != 'undefined') ident = newValue; return oldValue;}))
...
{ with(self)
{
    ...
    while (YES)
    {
        ...
        else if (objj_msgSend(self, "scanString:intoString:", "[", NULL))
        {
            ...
            {
                left = objj_msgSend(CPExpression, "expressionForFunction:arguments:", "index", objj_msgSend(CPArray, "arrayWithObjects:", left, objj_msgSend(self, "parseExpression"), nil));
            }
            if (!objj_msgSend(self, "scanString:intoString:", "]", NULL))
        ...
        else if (objj_msgSend(self, "scanString:intoString:", ".", NULL))
        {
            ...
            if (!objj_msgSend(right, "keyPath"))
                objj_msgSend(CPException, "raise:reason:", CPInvalidArgumentException, "Invalid right keypath:" + left);
...
{ with(self)
{
    ...
    while (YES)
    {
        ...
        if (objj_msgSend(self, "scanString:intoString:", "**", NULL))
        {
            ...
            left = objj_msgSend(CPExpression, "expressionForFunction:arguments:", "pow", objj_msgSend(CPArray, "arrayWithObjects:", left, right, nil));
        }
        else
        {
            return left;
...
{ with(self)
{
    ...
    while (YES)
    {
        ...
        if (objj_msgSend(self, "scanString:intoString:", "*", NULL))
        {
            ...
            left = objj_msgSend(CPExpression, "expressionForFunction:arguments:", "_mul", objj_msgSend(CPArray, "arrayWithObjects:", left, right, nil));
        }
        else if (objj_msgSend(self, "scanString:intoString:", "/", NULL))
        {
            right = objj_msgSend(self, "parsePowerExpression");
            left = objj_msgSend(CPExpression, "expressionForFunction:arguments:", "_div", objj_msgSend(CPArray, "arrayWithObjects:", left, right, nil));
        }
        else
        {
            return left;
...
{ with(self)
{
    ...
    while (YES)
    {
        ...
        if (objj_msgSend(self, "scanString:intoString:", "+", NULL))
        {
            ...
            left = objj_msgSend(CPExpression, "expressionForFunction:arguments:", "_add", objj_msgSend(CPArray, "arrayWithObjects:", left, right, nil));
        }
        else if (objj_msgSend(self, "scanString:intoString:", "-", NULL))
        {
            right = objj_msgSend(self, "parseMultiplicationExpression");
            left = objj_msgSend(CPExpression, "expressionForFunction:arguments:", "_sub", objj_msgSend(CPArray, "arrayWithObjects:", left, right, nil));
        }
        else
        {
            return left;
